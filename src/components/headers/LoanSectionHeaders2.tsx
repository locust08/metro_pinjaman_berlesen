...
const LoanSectionHeaders2: React.FC = () => {
    return (
        <section>
  ...
  <div className="relative">
    ...
    <div className="hidden lg:flex items-center justify-center absolute top-0 right-0 h-full max-w-lg xl:max-w-none xl:w-2/5 p-3 ml-auto">
      <img className="absolute bottom-0 left-0 -ml-16 max-w-md lg:h-52 rounded-2xl object-cover" src="flow-assets/metro/loan-hero-documents.webp" alt="" />
      <img className="block xl:h-full mx-auto rounded-full object-cover" src="flow-assets/metro/loan-hero-adviser.webp" alt="Borrower discussing loan options with an adviser" />
    </div>
    <div className="relative flex lg:hidden p-3 items-center justify-center">
      <img className="absolute top-0 right-0 -mt-16 w-44 h-32 rounded-2xl object-cover" src="flow-assets/metro/loan-hero-documents.webp" alt="" />
      <img className="block w-full max-w-2xl h-auto rounded-full object-cover" src="flow-assets/metro/loan-hero-adviser.webp" alt="Borrower discussing loan options with an adviser" />
    </div>
  </div>
...
export default LoanSectionHeaders2;
