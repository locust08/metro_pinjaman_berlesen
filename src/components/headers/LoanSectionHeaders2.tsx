...
const LoanSectionHeaders2: React.FC = () => {
  ...
  <div className="relative">
    ...
    <div className="hidden lg:flex items-center justify-center absolute top-0 right-0 h-full max-w-lg xl:max-w-none xl:w-2/5 p-3 ml-auto bg-lime-500">
      <img className="absolute bottom-0 left-0 -ml-16 max-w-md lg:h-52" src="../..//flow-assets/headers/card-small.png" alt="" />
      <img className="block xl:h-full mx-auto rounded-full" src="flow-assets/headers/image-hero-1.png" alt="" />
    </div>
    <div className="relative flex lg:hidden p-3 bg-lime-500 items-center justify-center">
      <img className="absolute top-0 right-0 -mt-16" src="../..//flow-assets/headers/card-small.png" alt="" />
      <img className="block w-full max-w-2xl h-auto rounded-full" src="flow-assets/headers/image-hero-1.png" alt="" />
    </div>
  </div>
