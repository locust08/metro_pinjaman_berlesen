...
const LoanSectionPricing1: React.FC = () => {
    return (
        <section className="relative py-12 lg:py-24 overflow-hidden">
  <img className="absolute top-0 right-0" src="flow-assets/pricing/waves-right-top.png" alt="" />
...
export default LoanSectionPricing1;
